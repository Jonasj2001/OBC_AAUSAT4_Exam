...
#set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { pio4 clr  }]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { CLK  }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
#set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { pio6 reg(0)  }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { pio7 reg(1)  }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
#set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { pio8 reg(2) }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
#set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { pio9 reg(3) }]; #IO_L6P_T0_16 Sch=pio[09]
#set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { pio10 reg(4)}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
#set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { pio11 reg(5) }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
#set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { pio12 reg(6) }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
#set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { pio13 reg(7)}]; #IO_L6N_T0_VREF_35 Sch=pio[13]
#set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { pio14 }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]
#set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { pio17 Cs }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
...
#set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { pio23 regClk}]; #IO_L19N_T3_VREF_35 Sch=pio[23]
#set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { pio26 SSO}]; #IO_L2P_T0_34 Sch=pio[26]
#set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports { pio27 SSF}]; #IO_L2N_T0_34 Sch=pio[27]
#set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { pio28 SGI}]; #IO_L1P_T0_34 Sch=pio[28]
#set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports { pio29 SFSMF }]; #IO_L3P_T0_DQS_34 Sch=pio[29]
#set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports { pio30 Reg0}]; #IO_L1N_T0_34 Sch=pio[30]
#set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports { pio31 Reg1}]; #IO_L3N_T0_DQS_34 Sch=pio[31]
#set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports { pio32 Sw(6)}]; #IO_L5N_T0_34 Sch=pio[32]
#set_property -dict { PACKAGE_PIN V2    IOSTANDARD LVCMOS33 } [get_ports { pio33 Sw(7) }]; #IO_L5P_T0_34 Sch=pio[33]
...
#set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { pio39 SI }]; #IO_L16N_T2_34 Sch=pio[39]
#set_property -dict { PACKAGE_PIN W4    IOSTANDARD LVCMOS33 } [get_ports { pio SO }]; #IO_L12N_T1_MRCC_34 Sch=pio[40]
...
#set_property PACKAGE_PIN T2 [get_ports {SI}]
#set_property PACKAGE_PIN M2 [get_ports {SO}]

#set_property IOSTANDARD LVTTL [get_ports {CLK}]
#set_property IOSTANDARD LVTTL [get_ports {SI}]
#set_property IOSTANDARD LVTTL [get_ports {SO}]

#set_property CLOCK_DEDICATED_ROUTE FALSE [get_ports CLoK];
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_ports SignalClockIn];


set_property IOSTANDARD LVTTL [get_ports Q]
set_property PACKAGE_PIN H1 [get_ports Q]

set_property PULLDOWN true [get_ports Q]

#set_property IOSTANDARD LVTTL [get_ports {InfoOutput[2]}]
set_property IOSTANDARD LVTTL [get_ports {InfoOutput[1]}]
set_property IOSTANDARD LVTTL [get_ports {InfoOutput[0]}]
set_property IOSTANDARD LVTTL [get_ports BitstreamIn]
set_property IOSTANDARD LVTTL [get_ports CLOK]
set_property IOSTANDARD LVTTL [get_ports CS]
set_property IOSTANDARD LVTTL [get_ports SingalOut]
...
set_property PULLUP true [get_ports CS]
set_property PULLDOWN true [get_ports CLOK]
set_property PULLDOWN true [get_ports BitstreamIn]
...
set_property IOSTANDARD LVTTL [get_ports SignalClockIn]
set_property IOSTANDARD LVTTL [get_ports signalStoredFlag]
set_property IOSTANDARD LVTTL [get_ports SignalStoredOut]
set_property PULLDOWN true [get_ports SignalClockIn]

set_property PACKAGE_PIN R2 [get_ports SignalGetInfo]
set_property IOSTANDARD LVTTL [get_ports SignalGetInfo]
set_property PULLDOWN true [get_ports SignalGetInfo]

set_property PULLDOWN true [get_ports signalStoredFlag]

set_property PULLDOWN true [get_ports SignalStoredOut]




set_property PACKAGE_PIN T1 [get_ports signalFSMFlag]
set_property IOSTANDARD LVTTL [get_ports signalFSMFlag]
set_property PULLDOWN true [get_ports signalFSMFlag]

set_property PACKAGE_PIN T2 [get_ports reg0]
set_property PACKAGE_PIN U1 [get_ports reg1]
set_property IOSTANDARD LVTTL [get_ports reg1]
set_property IOSTANDARD LVTTL [get_ports reg0]

set_property PULLDOWN true [get_ports reg0]
set_property PULLDOWN true [get_ports reg1]
