...
HD_PWD='C:/Users/paw/Desktop/AAUSAT6_P4/projects/fpga/FPGAStateMachineProject/FPGAStateMachineProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log StateMachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source StateMachine.tcl
