...
use hal::{pac::{self}, prelude::*, spi::{Event, Instance}, flash::FlashSector};
...
(flash: &mut Memory<SPI, PINS, P, N, MODE> ) {
    ...
    let empty: u8 = 0xff;
    let executed: u8 = 0x9;  
    let data = [executed, scheduled, executed, scheduled, executed, scheduled, executed, executed];
...
(flash: &mut Memory<SPI, PINS, P, N, MODE> ) {
    ...
    let empty: u8 = 0xff;
    let executed: u8 = 0x9;  
    let data = [executed, scheduled, executed, scheduled, executed, scheduled, executed, executed, scheduled, scheduled, scheduled,scheduled,scheduled, scheduled,scheduled,scheduled,executed];
